...
# TODO: set grid for stochastic search for hyperparameters
    ...
    def __init__(self, cov_matrix, input_dim, dimNodeSignals = [1, 16, 1], nTaps = 2, dimLayersMLP=[1]):
        super(MovieLensGNN, self).__init__()
        # TODO: for search, try multiple diff values (of elements) and sizes (of the list) fro dimNodeSignals
        nFilterTaps = [nTaps] * (len(dimNodeSignals) - 1) # values of each element >= 2|||| TODO: [2]/[3] for search.
