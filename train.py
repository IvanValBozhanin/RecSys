...
try:
    ...
    # internal_idx_to_original_movie_id_map was created earlier in train.py
    internal_idx_to_original_movie_id_map = create_movie_id_mapping(ratings_csv_file, M)
...
ratings_csv_path = 'ml-latest-small/ratings.csv'  # Update path as needed
...
# Load genre matrix from MovieLens movies.csv
movies_csv_path = 'ml-latest-small/movies.csv'  # Update path as needed
